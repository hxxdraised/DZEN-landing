        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {draft.map((member, index) => (
            <div
              ...
              className={cn(
                "group relative cursor-pointer overflow-hidden rounded-xl border bg-card transition-colors hover:border-primary/40",
            ...
            >
                ...
                {member.photoUrl ? (
                  ...
                  <div className="flex size-full items-center justify-center">
                    <span className="flex size-24 items-center justify-center rounded-full bg-muted text-2xl font-bold text-muted-foreground/60">
                      {initials(member.name) || <ImageIcon className="size-8" />}
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="p-4">
                ...
                <p className="mt-3 flex items-center justify-center gap-1 text-xs text-muted-foreground/60">
